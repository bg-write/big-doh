				...
				<div id="bigO-container">
					...
					<div className="item-container">
						...
						<p>
							...
							only have to do 1 more operation. EX Binary Search: look up a name
							in the phone book, read a name, and flip forwards or backwards
					...
					<div className="item-container">
						...
						<p>
							...
							print 10 times. EX A basic "For Loop": for each item, do a
							specific thing. (
							<a
					...
					<div className="item-container">
						...
						<p>
							...
							logarithmically. EX A basic "While For Loop": While something is
							true, for each item, do this specific thing. Also, Quick Sort and
							Merge Sort. (
							<a
					...
					<div className="item-container">
						...
						<p>
							...
							has 10 items, you have to print 100 times. EX Nesting two loops in
							the same function. (
							<a
					...
					<div className="item-container">
						...
						<p>
							...
							4 times, and if N = 3, your algorithm runs 8 times. EX Recursion
							and Fibonacci. (
							<a
					...
					<div className="item-container">
						...
						<p>
							...
							the correct output. 6! = 6*5*4*3*2*1 = 720. EX Brute Force and the
